...
public class FileSearchData extends SearchData {
  ...
  public FileSearchData() {
  }

  public FileSearchData(int id) {
    this.id = id;
  }

  public String getDataKey() {
    return LinkedFileData.DATAKEY;
  }
  ...
  public String getLink() {
    return " href=\"_file?method=show&fid=" + id + "\" target=\"_blank\"";
  }
