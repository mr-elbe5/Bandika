 ...
 * Usage:
 */
public class PageSortData extends BaseData implements Comparable<PageSortData> {

    protected int id = 0;
    protected int ranking = 0;
    protected String name = "";
    protected List<PageSortData> children = new ArrayList<>();
    ...
    public List<PageSortData> getChildren() {
        return children;
    }
