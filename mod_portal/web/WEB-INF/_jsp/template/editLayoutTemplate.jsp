...
<form class="form-horizontal" action="/template.srv" method="post" name="form" accept-charset="UTF-8"
    ...
    <input type="hidden" name="act" value="saveLayoutTemplate"/>
    ...
    <div class="well">
        ...
        <table class="table">
            ...
            <bandika:controlGroup labelKey="portal_download" name="download" padded="true">
                <a href="/template.srv?act=downloadLayoutTemplate&name=<%=data.getName()%>"><%=StringCache.getHtml("portal_download",locale)%>
                </a>
            </bandika:controlGroup>
    ...
    <div class="btn-toolbar">
        ...
        <button class="btn"
                onclick="return linkTo('/template.srv?act=openEditLayoutTemplates');"><%=StringCache.getHtml("webapp_back",locale)%>
        </button>
    </div>
</form>
