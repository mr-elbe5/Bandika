...
<table class="padded listTable" id="siteTable">
    ...
    <tr>
        <td>
            <a href="#" onclick="<%=String.format("if (CKEDITOR) CKEDITOR.tools.callFunction(%s, '/file.srv?fileId=%s'); closeBrowserLayer();", browseData.getCkCallbackNum(), site.getId())%>"><%=StringUtil.toHtml(site.getDisplayName())%>
            </a>
        </td>
    </tr>
    </tbody>
...
<table class="padded listTable topspace" id="pagesTable">
    ...
    <tr>
        <td>
            <a href="#" onclick="<%=String.format("if (CKEDITOR) CKEDITOR.tools.callFunction(%s, '/file.srv?fileId=%s'); closeBrowserLayer();", browseData.getCkCallbackNum(), pageData.getId())%>"><%=StringUtil.toHtml(pageData.getDisplayName())%>
            </a>
        </td>
    </tr>
    <%}%>
