...
<%@ page import = "de.elbe5.cms.field.ImageLinkField" %>
...
%>
        ...
        <div class = "buttonset topspace">
            <button class = "primary" onclick = "setImageLink('<%=field.getIdentifier()%>');return closeEditLayer();"><%=StringUtil.getHtml("_ok", locale)%></button>
        </div>
