...
<%@ page import = "de.elbe5.cms.file.FileBean" %>
    ...
    <fieldset>
        ...
        <table class = "versions">
            ...
            <tr>
                ...
                <td>
                    <a href = "/file.srv?act=show&fileId=<%=data.getId()%>&version=<%=data.getLoadedVersion()%>" target = "_blank"><%=StringUtil.getHtml("_view", locale)%></a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <a href = "/file.srv?act=show&fileId=<%=versionData.getId()%>&version=<%=versionData.getLoadedVersion()%>" target = "_blank"><%=StringUtil.getHtml("_view", locale)%></a>
