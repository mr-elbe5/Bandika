...
<form action = "/page.srv" method = "post" id = "layoutform" name = "layoutform" accept-charset = "UTF-8">
    <fieldset>
        <input type = "hidden" name = "siteId" value = "<%=siteId%>"/> <input type = "hidden" name = "act" value = "createPage"/>
        <table class = "form">
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    %>
                <div>
                    <input type = "radio" name = "templateName" value = "<%=tdata.getFileName()%>" <%=first ? "checked=\"checked\"" : ""%>/><%=StringUtil.toHtml(tdata.getFileName())%>
                </div>
                    <%
                            first = false;
                        }
