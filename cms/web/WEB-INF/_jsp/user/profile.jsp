...
<div class="row">
    <section class="col-md-8 contentSection">
        <div class="paragraph">
            ...
            <cms:line label="<%=Strings._login.toString()%>"><%=StringUtil.toHtml(user.getLogin())%>
            </cms:line>
            <cms:line label="<%=Strings._title.toString()%>"><%=StringUtil.toHtml(user.getTitle())%>
            </cms:line>
            <cms:line label="<%=Strings._firstName.toString()%>"><%=StringUtil.toHtml(user.getFirstName())%>
            </cms:line>
            ...
            <cms:line label="<%=Strings._zipCode.toString()%>"><%=StringUtil.toHtml(user.getZipCode())%>
            </cms:line>
            <cms:line label="<%=Strings._city.toString()%>"><%=StringUtil.toHtml(user.getCity())%>
            </cms:line>
            <cms:line label="<%=Strings._country.toString()%>"><%=StringUtil.toHtml(user.getCountry())%>
            </cms:line>
            <h3><%=Strings._contact.html(locale)%>
            </h3>
            <cms:line label="<%=Strings._email.toString()%>"><%=StringUtil.toHtml(user.getEmail())%>
            </cms:line>
            <cms:line label="<%=Strings._phone.toString()%>"><%=StringUtil.toHtml(user.getPhone())%>
            </cms:line>
            <cms:line label="<%=Strings._fax.toString()%>"><%=StringUtil.toHtml(user.getFax())%>
            </cms:line>
            <cms:line label="<%=Strings._mobile.toString()%>"><%=StringUtil.toHtml(user.getMobile())%>
            </cms:line>
        </div>
    </section>
