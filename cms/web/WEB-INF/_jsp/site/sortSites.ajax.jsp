...
<%@ page import="de.elbe5.cms.tree.TreeNodeSortData" %>
<%@ page import="java.util.Locale" %>
<%@ page import="de.elbe5.cms.site.SiteActions" %>
<%@ page import="de.elbe5.cms.tree.TreeActions" %>
...
<form action="/site.srv" method="post" name="rankform" id="rankform" accept-charset="UTF-8">
    <input type="hidden" name="act" value="<%=SiteActions.saveSortSites%>"/>
...
<script type="text/javascript">
    ...
    function setRanking(idx) {
        ...
        if (sel) {
            ...
            document.rankform.act.value = '<%=SiteActions.changeSiteRanking%>';
            var $form = $('#rankform');
