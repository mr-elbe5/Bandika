...
CKEDITOR.lang['sk'] = {
    ...
    "basicstyles": {"bold": "Tučné", "italic": "Kurzíva", "strike": "Prečiarknuté", "subscript": "Dolný index", "superscript": "Horný index", "underline": "Podčiarknuté"},
    ...
    "colordialog": {"clear": "Vyčistiť", "highlight": "Zvýrazniť", "options": "Možnosti farby", "selected": "Vybraná farba", "title": "Vyberte farbu"},
    "templates": {
        "button": "Šablóny",
    ...
    "fakeobjects": {"anchor": "Kotva", "flash": "Flash animácia", "hiddenfield": "Skryté pole", "iframe": "IFrame", "unknown": "Neznámy objekt"},
    "flash": {
    ...
    "font": {"fontSize": {"label": "Veľkosť", "voiceLabel": "Veľkosť písma", "panelTitle": "Veľkosť písma"}, "label": "Font", "panelTitle": "Názov fontu", "voiceLabel": "Font"},
    "forms": {
        ...
        "form": {"title": "Vlastnosti formulára", "menu": "Vlastnosti formulára", "action": "Akcia (action)", "method": "Metóda (method)", "encoding": "Kódovanie (encoding)"},
    ...
    "iframe": {"border": "Zobraziť rám frame-u", "noUrl": "Prosím, vložte URL iframe", "scrolling": "Povoliť skrolovanie", "title": "Vlastnosti IFrame", "toolbar": "IFrame"},
    "image": {
    ...
    "table": {
        ...
        "column": {"menu": "Stĺpec", "insertBefore": "Vložiť stĺpec pred", "insertAfter": "Vložiť stĺpec po", "deleteColumn": "Zmazať stĺpce"},
        "columns": "Stĺpce",
