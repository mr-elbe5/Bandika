...
CKEDITOR.lang['cs'] = {
    ...
    "basicstyles": {"bold": "Tučné", "italic": "Kurzíva", "strike": "Přeškrtnuté", "subscript": "Dolní index", "superscript": "Horní index", "underline": "Podtržené"},
    ...
    "colordialog": {"clear": "Vyčistit", "highlight": "Zvýraznit", "options": "Nastavení barvy", "selected": "Vybráno", "title": "Výběr barvy"},
    "templates": {
        "button": "Šablony",
    ...
    "fakeobjects": {"anchor": "Záložka", "flash": "Flash animace", "hiddenfield": "Skryté pole", "iframe": "IFrame", "unknown": "Neznámý objekt"},
    "flash": {
    ...
    "font": {"fontSize": {"label": "Velikost", "voiceLabel": "Velikost písma", "panelTitle": "Velikost"}, "label": "Písmo", "panelTitle": "Písmo", "voiceLabel": "Písmo"},
    "forms": {
        "button": {"title": "Vlastnosti tlačítka", "text": "Popisek", "type": "Typ", "typeBtn": "Tlačítko", "typeSbm": "Odeslat", "typeRst": "Obnovit"},
        "checkboxAndRadio": {"checkboxTitle": "Vlastnosti zaškrtávacího políčka", "radioTitle": "Vlastnosti přepínače", "value": "Hodnota", "selected": "Zaškrtnuto"},
        "form": {"title": "Vlastnosti formuláře", "menu": "Vlastnosti formuláře", "action": "Akce", "method": "Metoda", "encoding": "Kódování"},
    ...
    "iframe": {"border": "Zobrazit okraj", "noUrl": "Zadejte prosím URL obsahu pro IFrame", "scrolling": "Zapnout posuvníky", "title": "Vlastnosti IFrame", "toolbar": "IFrame"},
    "image": {
    ...
    "stylescombo": {"label": "Styl", "panelTitle": "Formátovací styly", "panelTitle1": "Blokové styly", "panelTitle2": "Řádkové styly", "panelTitle3": "Objektové styly"},
    "table": {
        "border": "Ohraničení",
        "caption": "Popis",
        "cell": {
        ...
        "column": {"menu": "Sloupec", "insertBefore": "Vložit sloupec před", "insertAfter": "Vložit sloupec za", "deleteColumn": "Smazat sloupec"},
        "columns": "Sloupce",
