...
CKEDITOR.lang['si'] = {
    ...
    "colordialog": {"clear": "පැහැදිලි", "highlight": "මතුකර පෙන්වන්න", "options": "වර්ණ විකල්ප", "selected": "තෙරු වර්ණ", "title": "වර්ණ තෝරන්න"},
    "templates": {
        "button": "අච්චුව",
    ...
    "fakeobjects": {"anchor": "ආධාරය", "flash": "Flash Animation", "hiddenfield": "සැඟවුණු ප්රදේශය", "iframe": "IFrame", "unknown": "Unknown Object"},
    "flash": {
    ...
    "forms": {
        ...
        "checkboxAndRadio": {"checkboxTitle": "ලකුණු කිරීමේ කොටුවේ ලක්ෂණ", "radioTitle": "Radio Button Properties", "value": "Value", "selected": "Selected"},
        "form": {"title": "පෝරමයේ ", "menu": "පෝරමයේ ගුණ/", "action": "ගන්නා පියවර", "method": "ක්රමය", "encoding": "කේතීකරණය"},
    ...
    "iframe": {"border": "සැකිල්ලේ කඩයිම් ", "noUrl": "කරුණාකර රුපයේ URL ලියන්න", "scrolling": "සක්ක්රිය කරන්න", "title": "IFrame Properties", "toolbar": "IFrame"},
    "image": {
    ...
    "smiley": {"options": "හාස්ය විකල්ප", "title": "හාස්යන් ඇතුලත් කිරීම", "toolbar": "හාස්යන්"},
    "justify": {"block": "Justify", "center": "මධ්ය", "left": "Align Left", "right": "Align Right"},
    "link": {
    ...
    "pagebreak": {"alt": "පිටු බිදුම", "toolbar": "මුද්රණය සඳහා පිටු බිදුමක් ඇතුලත් කරන්න"},
    ...
    "stylescombo": {"label": "විලාසය", "panelTitle": "Formatting Styles", "panelTitle1": "Block Styles", "panelTitle2": "Inline Styles", "panelTitle3": "Object Styles"},
    "table": {
