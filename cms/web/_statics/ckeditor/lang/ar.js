...
CKEDITOR.lang['ar'] = {
    ...
    "basicstyles": {"bold": "عريض", "italic": "مائل", "strike": "يتوسطه خط", "subscript": "منخفض", "superscript": "مرتفع", "underline": "تسطير"},
    ...
    "colordialog": {"clear": "مسح", "highlight": "تحديد", "options": "اختيارات الألوان", "selected": "اللون المختار", "title": "اختر اللون"},
    "templates": {
        "button": "القوالب",
    ...
    "fakeobjects": {"anchor": "إرساء", "flash": "رسم متحرك بالفلاش", "hiddenfield": "إدراج حقل خفي", "iframe": "iframe", "unknown": "عنصر غير معروف"},
    "flash": {
    ...
    "font": {"fontSize": {"label": "حجم الخط", "voiceLabel": "حجم الخط", "panelTitle": "حجم الخط"}, "label": "خط", "panelTitle": "حجم الخط", "voiceLabel": "حجم الخط"},
    "forms": {
        "button": {"title": "خصائص زر الضغط", "text": "القيمة/التسمية", "type": "نوع الزر", "typeBtn": "زر", "typeSbm": "إرسال", "typeRst": "إعادة تعيين"},
        "checkboxAndRadio": {"checkboxTitle": "خصائص خانة الإختيار", "radioTitle": "خصائص زر الخيار", "value": "القيمة", "selected": "محدد"},
    ...
    "iframe": {"border": "إظهار حدود الإطار", "noUrl": "فضلا أكتب رابط الـ iframe", "scrolling": "تفعيل أشرطة الإنتقال", "title": "خصائص iframe", "toolbar": "iframe"},
    "image": {
    ...
    "stylescombo": {"label": "أنماط", "panelTitle": "أنماط التنسيق", "panelTitle1": "أنماط الفقرة", "panelTitle2": "أنماط مضمنة", "panelTitle3": "أنماط الكائن"},
    "table": {
        "border": "الحدود",
        "caption": "الوصف",
        "cell": {
