...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {
            timestamp: "D9EF", version: "4.2.2", revision: "f98db6d8", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, j = {"#": 1}, i = {center: 1, dir: 1, noframes: 1};
        b(a, {
            a: 1,
            abbr: 1,
            area: 1,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {
        focus: function () {
            ...
            b = b.document;
            return {
                x: b.documentElement.scrollLeft || b.body.scrollLeft || 0, y: b.documentElement.scrollTop || b.body.scrollTop || 0
            }
        }, getFrame: function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var i = this.$.getBoundingClientRect(), l = e.$.documentElement, m = l.clientTop || h.$.clientTop || 0, q = l.clientLeft || h.$.clientLeft || 0, w = true;
                    if (CKEDITOR.env.ie) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.documentFragment.prototype, CKEDITOR.dom.element.prototype, {
        type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, insertAfterNode: function (b) {
            b = b.$;
            b.parentNode.insertBefore(this.$, b.nextSibling)
        }
    }, !0, {
    ...
    (function () {
        function b(a, b) {
            ...
            if (this.current)d = this.current[e](false, p, k); else {
                if (a)d.type == CKEDITOR.NODE_ELEMENT && (d = f > 0 ? d.getChild(f - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, p, k)); else {
                    d = m;
    ...
    (function () {
        ...
        function c(a) {
            ...
            return function (k) {
                return c(k) || b(k) ? true : !a && h(k) || k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$removeEmpty)
            }
        }
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                            ...
                            for (; h;) {
                                ...
                                if (h.type == CKEDITOR.NODE_COMMENT)h = h.getPrevious(); else {
                                    if (h.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        x = h.getText();
                                        if (/[^\s\ufeff]/.test(x))h = null; else for (var l = h.$.getElementsByTagName("*"), s = 0, C; C = l[s++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            h = null;
                                            break
                                        }
                                        h && (r = !!x.length)
                ...
                var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, g = c.block, e = null;
    ...
    (function () {
        ...
        b.prototype = {
            getNextParagraph: function (b) {
                ...
                if (!this._.nextNode)this._.nextNode = l || d.equals(m) || !m ? null : c(d, 1, m);
                return d
            }
        };
    ...
    (function () {
            ...
            return a._.filterFunction = function (d, e, f, h, k, q, o) {
                ...
                if (e) {
                    var n = d.name, f = e.elements[n], t = e.generic, e = {
                        valid: false, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: false, allClasses: false, allStyles: false
                    };
                    if (!f && !t) {
                        h.push(d);
                        return true
                ...
                if (g) {
                    ...
                    for (var e = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body", p, f = d.length; f > 0;) {
                        ...
                        if (e && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && B.$inline[h.name])) {
                            ...
                            p = null;
                            h.insertAfter(a);
                            g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (h.type == CKEDITOR.NODE_ELEMENT && !B[g.name][h.name]) && c.push({check: "el-up", el: h})
                        }
                    }
                    a.remove()
                }
        ...
        function v(a, b) {
            ...
            for (e in d)if (e == "class") {
                c = d[e].split(/\s+/);
                for (h = a.classes.join("|"); p = c.pop();)if (h.indexOf(p) == -1)return false
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                d.length && (q = true);
                for (var o, n, a = [], c = ["p", "br", "div"][this.enterMode - 1]; o = d.pop();)o.type == CKEDITOR.NODE_ELEMENT ? g(o, c, a) : o.remove();
                for (; n = a.pop();) {
                    o = n.el;
                ...
                if (typeof a == "string") {
                    ...
                    g = {
                        name: d.element, attributes: o, classes: o["class"] ? o["class"].split(/\s+/) : [], styles: g, children: []
                    }
                }
        ...
        var s = {styles: 1, attributes: 1, classes: 1}, C = {
            styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"
    ...
    (function () {
        ...
        function m(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var k in c) {
                    var q = c[k], o = q.lang, n = null, i = q.requires, j;
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                var c = this.getCommand(a), d = {
                    name: a, commandData: b, command: c
                };
    ...
    CKEDITOR.htmlParser.comment.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        type: CKEDITOR.NODE_COMMENT, filter: function (b) {
            var c = this.value;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_TEXT, filter: function (b) {
    ...
    (function () {
        ...
        var c = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), a = {
            ol: 1,
            ul: 1
        }, f = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1});
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, e, h) {
            function j(a) {
                var b;
                if (p.length > 0)for (var c = 0; c < p.length; c++) {
                    var d = p[c], e = d.name, g = CKEDITOR.dtd[e], f = t.name && CKEDITOR.dtd[t.name];
    ...
    (function () {
        ...
        function n(a, b) {
            ...
            a = a.replace(e, function (a, b, d) {
                return "<\!--" + B + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\>"
            });
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: c.add, clone: function () {
                ...
                c && this.filter(c);
                var d = this.name, e = [], h = this.attributes, j, i;
                a.openTag(d, h);
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, j = a.elementMode, i = a.fire("uiSpace", {space: "top", html: ""}).html, l = a.fire("uiSpace", {space: "bottom", html: ""}).html;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, f) {
            var i = this.container, l = this.ui.space("contents"), m = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, f = f ? i.getChild(1) : i;
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    e(this);
                    for (var c = this.editor, d = c.config.enterMode, g = c.getSelection(), f = g.getRanges(), i = b.getName(), j = CKEDITOR.dtd.$block[i], n, m, l, r = f.length - 1; r >= 0; r--) {
                        n = f[r];
                        if (!n.checkReadOnly()) {
                            n.deleteContents(1);
                            m = !r && b || b.clone(1);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in{8: 1, 46: 1}) {
                                var e = a.getSelection(), b = e.getRanges()[0], f = b.startPath(), h, k, j, c = c == 8;
                                if (e = d(e)) {
                                    a.fire("saveSnapshot");
                                    ...
                                    a.fire("saveSnapshot");
                                    g = 1
                                } else if (f.blockLimit && f.blockLimit.is("td") && (k = f.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (j = k[c ? "getPrevious" : "getNext"](i))) {
                                    a.fire("saveSnapshot");
                                    b["moveToElementEdit" + (c ? "End" : "Start")](j);
        ...
        var m = function () {
            ...
            var i = CKEDITOR.dtd, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, j = {
                p: 1,
                div: 1,
                h1: 1,
                h2: 1,
            ...
            return function (n, l, z) {
                var s = n.editor;
                n.getDocument();
                var C = s.getSelection().getRanges()[0], y = false;
    ...
    (function () {
            ...
            f.on("contentDom", function () {
                ...
                if (CKEDITOR.env.ie && !i) {
                    ...
                    g.attachListener(g, "mousedown", function (a) {
                        a.data.$.button == 2 && f.document.$.selection.type == "None" && (w = f.window.getScrollPosition())
                    });
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, b); else if (CKEDITOR.env.gecko)b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, b, true); else if (CKEDITOR.env.ie) {
                ...
                if (q)b.type == "None" && (c && c.equals(this.document.getDocumentElement())) && j(a, null, true); else {
                ...
                return function (b) {
                    ...
                    if (b)for (var d = c.ranges, e = 0; e < d.length; e++) {
                        ...
                        if (!f.collapsed) {
                            ...
                            h && h.type == CKEDITOR.NODE_TEXT && (l ? j.setEndAfter(h) : j.setEndBefore(h));
                    ...
                    if (q) {
                        ...
                        for (d = 0; d < a.length; d++) {
                            ...
                            if (CKEDITOR.env.opera && b.collapsed && i.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (!l && !c && i.is(CKEDITOR.dtd.$removeEmpty) || l && l.type == CKEDITOR.NODE_ELEMENT || c && c.type == CKEDITOR.NODE_ELEMENT) {
    ...
    (function () {
                    ...
                    if (m.equals(j)) {
                        ...
                        if (!s || i[s] && !t && (!n || h) && (m.getPosition(j) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(m))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                if (!q && (!s || !CKEDITOR.dtd.$removeEmpty[s] || (m.getPosition(j) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED)) {
                                    q = a.clone();
                                    q.setStartBefore(m)
                                }
                                if (r == CKEDITOR.NODE_TEXT || n || r == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                    for (var r = m, x; (g = !r.getNext(C)) && (x = r.getParent(), i[x.getName()]) && (x.getPosition(k) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(x));)r = x;
                                    q.setEndAfter(r)
                                }
                            } else g = true
                        } else g = true;
        ...
        function a(a) {
            ...
            if (a.collapsed) {
                ...
                var i = b.endNode, l = this, d = function () {
                    ...
                    getNextRange: function (h) {
                        ...
                        if (j && a.length > 1) {
                            ...
                            if (h)for (var l = 0; a[e + l + 1];) {
                                for (var m = j.document, h = 0, i = m.getById(c[l].endNode), m = m.getById(c[l + 1].startNode); ;) {
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function e(b) {
                if (l == CKEDITOR.dialog._.currentTop) {
                    ...
                    o = i = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9)c = c == CKEDITOR.SHIFT + 9, l._.tabBarMode ? (c = c ? p.call(l) : u.call(l), l.selectPage(c), l._.tabs[c][0].focus()) : d(c ? -1 : 1), o = 1; else if (c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount())l._.tabBarMode = !0, l._.tabs[l._.currentTabId][0].focus(), o = 1; else if ((37 == c || 39 == c) && l._.tabBarMode)c = c == (f ? 39 : 37) ? p.call(l) : u.call(l), l.selectPage(c), l._.tabs[c][0].focus(), o = 1; else if ((13 == c || 32 == c) && l._.tabBarMode)this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, d(1), o = 1; else if (13 == c) {
                        c = b.data.getTarget();
            ...
            var f = CKEDITOR.dialog._.dialogDefinitions[b], k = CKEDITOR.tools.clone(W), m = a.config.dialog_buttonsOrder || "OS", j = a.lang.dir, h = {}, o, i;
            ...
            destroy: function () {
                ...
                return function (a, b) {
                    if (!this._.contentSize || !(this._.contentSize.width == a && this._.contentSize.height == b))CKEDITOR.dialog.fire("resize", {
                        ...
                        width: a,
                        height: b
                    }, this._.editor), this.fire("resize", {width: a, height: b}, this._.editor), this.parts.contents.setStyles({
                        width: a + "px",
                        height: b + "px"
        ...
        CKEDITOR.tools.extend(CKEDITOR.dialog, {
            add: function (a, b) {
                ...
                var a = function (a, c) {
                    c = c || {};
                    return CKEDITOR.tools.extend({
                        id: "cancel", type: "button", label: a.lang.common.cancel, "class": "cke_dialog_ui_button_cancel", onClick: function (a) {
                            a = a.data.dialog;
        ...
        CKEDITOR.plugins.add("dialogadvtab", {
            requires: "dialog", allowedContent: function (c) {
                ...
                if (a.styles || a.classes)e = [], a.styles && e.push({
                    ...
                    type: "hbox", widths: ["50%", "50%"], children: [].concat(e)
                });
                return h
            }
        })
    ...
    (function () {
        function w(a) {
            ...
            function i(d, b) {
                ...
                if (!c.getById("cke_pastebin")) {
                    var h = a.getSelection(), o = h.createBookmarks(), j = new CKEDITOR.dom.element((CKEDITOR.env.webkit || e.is("body")) && !CKEDITOR.env.ie && !CKEDITOR.env.opera ? "body" : "div", c);
        ...
        function z() {
            var a = new CKEDITOR.htmlParser.filter, b = {
                    ...
                    table: 1,
                    ul: 1
                }, e = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline), c = {p: 1, br: 1, "cke:br": 1}, f = CKEDITOR.dtd, h = CKEDITOR.tools.extend({
                    area: 1,
                    basefont: 1,
                    embed: 1,
                    iframe: 1,
                    ...
                    if (!a) {
                        if (this.isFramed) {
                            ...
                            a.write(g.output(CKEDITOR.tools.extend({
                                css: CKEDITOR.tools.buildStyleHtml(this.css), onload: "window.parent.CKEDITOR.tools.callFunction(" + b + ");"
                            }, c)));
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (a, b, c, h) {
                ...
                addBlock: function (a, b) {
                    ...
                    if (m && (1 == c || 4 == c))f += b.$.offsetWidth; else if (!m && (2 == c || 3 == c))f += b.$.offsetWidth - 1;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = e.element.getWindow(), a = d.$.getBoundingClientRect(), b = b.getViewPaneSize(), c = a.width || a.right - a.left, g = a.height || a.bottom - a.top, h = m ? a.right : b.width - a.left, i = m ? b.width - a.right : a.left;
            ...
            requires: "dialog", init: function (a) {
                if (!a.blockless) {
                    ...
                    a.addCommand("creatediv", new CKEDITOR.dialogCommand("creatediv", {
                        allowedContent: b, requiredContent: "div", contextSensitive: !0, refresh: function (a, c) {
    ...
    (function () {
        ...
        function n(a) {
            return a._.toolbarGroups || (a._.toolbarGroups = [{name: "document", groups: ["mode", "document", "doctools"]}, {
                ...
                }, {name: "editing", groups: ["find", "selection", "spellchecker"]}, {name: "forms"}, "/", {name: "basicstyles", groups: ["basicstyles", "cleanup"]}, {
                    ...
                    if (j && h) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            ...
                            if (d.is("li"))if (i || m)a[i ? "insertBefore" : "insertAfter"](d); else a.breakParent(d); else {
                                if (e)if (d = f.createElement(c == CKEDITOR.ENTER_P ? "p" : "div"), l && d.setAttribute("dir", j), n && d.setAttribute("style", n), h && d.setAttribute("class", h), a.moveChildren(d), i || m)d[i ? "insertBefore" : "insertAfter"](b); else a.breakParent(b), d.insertAfter(b); else if (a.appendBogus(), i || m)for (; f = a[i ? "getFirst" : "getLast"]();)f[i ? "insertBefore" : "insertAfter"](b); else for (a.breakParent(b); f = a.getLast();)f.insertAfter(b);
                                a.remove()
                            }
                            k.selectBookmarks(g);
                            return
    ...
    CKEDITOR.plugins.add("find", {
        requires: "dialog", init: function (a) {
            ...
            a.ui.addButton && (a.ui.addButton("Find", {label: a.lang.find.find, command: "find", toolbar: "find,10"}), a.ui.addButton("Replace", {
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.createFakeParserElement = function (a, b, c, d) {
            ...
            f = f.getHtml();
            b = {
                "class": b, "data-cke-realelement": encodeURIComponent(f), "data-cke-real-node-type": a.type, alt: e, title: e, align: a.attributes.align || ""
            };
            CKEDITOR.env.hc || (b.src = CKEDITOR.getUrl(k.path + "images/spacer.gif"));
            c && (b["data-cke-real-element-type"] = c);
    ...
    (function () {
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                a.block = {
                    multiSelect: a.multiSelect, attributes: a.attributes
                };
                a.toolbarRelated = !0;
    ...
    CKEDITOR.plugins.add("forms", {
        requires: "dialog,fakeobjects", onLoad: function () {
            ...
            b.addMenuItems && (d = {
                ...
                textfield: {
                    label: a.forms.textfield.title, command: "textfield", group: "textfield"
                },
            ...
            b.on("doubleclick", function (a) {
                ...
                if (!b.blockless && c.is("form"))a.data.dialog = "form"; else if (c.is("select"))a.data.dialog = "select"; else if (c.is("textarea"))a.data.dialog = "textarea"; else if (c.is("img") && c.data("cke-real-element-type") == "hiddenfield")a.data.dialog = "hiddenfield"; else if (c.is("input")) {
            ...
            if (!a.blockless) {
                ...
                0 !== l && a.ui.addRichCombo("Format", {
                    label: c.label, title: c.panelTitle, toolbar: "styles,20", allowedContent: m, panel: {
                        css: [CKEDITOR.skin.getPath("editor")].concat(g.contentsCss), multiSelect: !1, attributes: {"aria-label": c.panelTitle}
                    }, init: function () {
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (a) {
                ...
                a.ui.addButton && (a.ui.addButton("Indent", {
                    ...
                    directional: !0,
                    toolbar: "indent,20"
                }), a.ui.addButton("Outdent", {label: a.lang.indent.outdent, command: "outdent", directional: !0, toolbar: "indent,10"}));
    ...
    (function () {
        ...
        function f(a, c, b) {
            ...
            this.value = b;
            this.context = "p";
            var c = a.config.justifyClasses, g = a.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div";
            if (c) {
                switch (b) {
                    case "left":
            ...
            this.allowedContent = {
                "caption div h1 h2 h3 h4 h5 h6 p pre td th li": {
                    propertiesOnly: !0, styles: this.cssClassName ? null : "text-align", classes: this.cssClassName || null
                }
            };
                ...
                init: function (a) {
                    if (!a.blockless) {
                        ...
                        a.ui.addButton && (a.ui.addButton("JustifyLeft", {
                            ...
                            label: a.lang.justify.center, command: "justifycenter", toolbar: "align,20"
    ...
    CKEDITOR.plugins.add("link", {
        requires: "dialog,fakeobjects", onLoad: function () {
            ...
            var a = "background:url(" + CKEDITOR.getUrl(this.path + "images" + (CKEDITOR.env.hidpi ? "/hidpi" : "") + "/anchor.png") + ") no-repeat %1 center;border:1px dotted #00f;background-size:16px;", d = ".%2 a.cke_anchor,.%2 a.cke_anchor_empty,.cke_editable.%2 a[name],.cke_editable.%2 a[data-cke-saved-name]{" + a + "padding-%1:18px;cursor:auto;}" + (CKEDITOR.env.ie ? "a.cke_anchor_empty{display:inline-block;}" : "") + ".%2 img.cke_anchor{" + a + "width:16px;min-height:15px;height:1.15em;vertical-align:" + (CKEDITOR.env.opera ? "middle" : "text-bottom") + ";}";
            ...
            b.ui.addButton && (b.ui.addButton("Link", {label: b.lang.link.toolbar, command: "link", toolbar: "links,10"}), b.ui.addButton("Unlink", {
    ...
    (function () {
        ...
        x.prototype = {
            exec: function (c) {
                ...
                for (var j = f.createBookmarks(!0), i = [], h = {}, b = b.createIterator(), g = 0; (e = b.getNextRange()) && ++g;) {
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist", init: function (c) {
                c.blockless || (c.addCommand("numberedlist", new x("numberedlist", "ol")), c.addCommand("bulletedlist", new x("bulletedlist", "ul")), c.ui.addButton && (c.ui.addButton("NumberedList", {
                    ...
                    label: c.lang.list.bulletedlist, command: "bulletedlist", directional: !0, toolbar: "list,20"
                })), c.on("key", function (j) {
    ...
    (function () {
        ...
        function X(a) {
            ...
            if (!f)return null;
            o(a, f);
            var e = Math.min(e, 0 | f.size.outerHeight / 2), c = [], h, j;
            ...
            } else f.equals(a.editable[j ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), j && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? h = y : 0 < b.y && b.y < f.size.top + e && (h = x)) : h = s, c = [null, f][j ? "reverse" : "concat"]().concat([j ? W : D, G, h, f.equals(a.editable[j ? "getLast" : "getFirst"](a.isRelevant)) ? j ? y : x : s]);
        ...
        function N(a, b, d, e) {
            ...
            }(), c = b.getDocumentPosition(), h = {}, j = {}, g = {}, i = {}, l = t.length; l--;)h[t[l]] = parseInt(f("border-" + t[l] + "-width"), 10) || 0, g[t[l]] = parseInt(f("padding-" + t[l]), 10) || 0, j[t[l]] = parseInt(f("margin-" + t[l]), 10) || 0;
            (!d || e) && H(a, e);
            ...
            return q({
                border: h, padding: g, margin: j, ignoreScroll: d
            }, i, !0)
        }
        ...
        function H(a, b) {
            ...
            if (b || !(d && d.date > new Date - Z)) {
                ...
                q(a.view, {
                    scroll: {
                        x: d.x, y: d.y, width: a.doc.$.documentElement.scrollWidth - e.width, height: a.doc.$.documentElement.scrollHeight - e.height
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                ...
                var d = a.config, e = d.magicline_triggerOffset || 30, f = d.enterMode, c = {
                    ...
                    triggers: d.magicline_everywhere ? T : {table: 1, hr: 1, div: 1, ul: 1, ol: 1, dl: 1, form: 1, blockquote: 1}
                }, h, j, g;
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    a.addMode("source", function (e) {
                        ...
                        b.setStyles(CKEDITOR.tools.extend({
                            width: CKEDITOR.env.ie7Compat ? "99%" : "100%", height: "100%", resize: "none", outline: "none", "text-align": "left"
    ...
    CKEDITOR.plugins.sourcearea = {
        commands: {
            source: {
                modes: {wysiwyg: 1, source: 1}, editorFocus: !1, readOnly: 1, exec: function (c) {
                    ...
                    if (!h || !h.length) {
                        ...
                        if (i) {
                            a.addMenuItem("scayt_moresuggest", {
                                label: g.moreSuggestions, group: "scayt_moresuggest", order: 10, getItems: function () {
                                    return f
                                }
                            });
            ...
            requires: "table,dialog,contextmenu", init: function (e) {
                ...
                e.addMenuItems && e.addMenuItems({
                    ...
                    tablecell_insertBefore: {
                        label: c.cell.insertBefore, group: "tablecell", command: "cellInsertBefore", order: 5
                    },
