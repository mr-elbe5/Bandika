            ...
            id: "info", label: c.title, accessKey: "I", elements: [{
                type: "hbox", widths: ["40%", "5%", "40%"], children: [{
                    type: "vbox", padding: 0, children: [{
                        ...
                        type: "select", id: "wordWrap", label: c.wordWrap, "default": "yes", items: [[c.yes, "yes"], [c.no, "no"]], setup: function (a) {
                    ...
                    type: "vbox", padding: 0, children: [{
                        type: "select", id: "cellType", label: c.cellType, "default": "td", items: [[c.data, "td"], [c.header, "th"]], setup: function (a) {
                        ...
                        type: "text", id: "colSpan", label: c.colSpan, "default": "", validate: h.integer(c.invalidColSpan), setup: function (a) {
