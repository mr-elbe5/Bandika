...
(function () {
        ...
        return {
            postMessage: {
                init: function (a) {
                    ...
                    "[object Object]" == Object.prototype.toString.call(a.message) && (a.message.id || (a.message.id = f), h = a.message);
    ...
    a.LocalizationButton = {
        ...
        IgnoreAllWords: {
            instance: null, text: "Ignore all words"
        },
    ...
    a.buildSelectLang = function (a) {
        ...
        c.setStyles({
            height: "auto", position: "absolute", right: "0", top: "-1px", width: "160px", "white-space": "normal"
        });
        d.setAttribute("id", a);
    ...
    a.buildOptionLang = function (b, c) {
        ...
        if (0 === d.options.length) {
            ...
            e.sort();
            for (var k = 0; k < e.length; k++)g = document.createElement("option"), g.setAttribute("value", e[k][1]), h = document.createTextNode(e[k][0]), g.appendChild(h), e[k][1] == a.selectingLang && g.setAttribute("selected", "selected"), f.appendChild(g);
            d.appendChild(f)
        }
    };
    ...
    var o = function (a) {
        var c = document, d = a.target || c.body, f = a.id || "overlayBlock", g = a.opacity || "0.9", a = a.background || "#f1f1f1", e = c.getElementById(f), i = e || c.createElement("div");
        ...
        var f = new CKEDITOR.dom.element("div"), g = new CKEDITOR.dom.element("input"), e = new CKEDITOR.dom.element("label"), i = "wscGrammerSuggest" + b + "_" + c;
        ...
        e.setStyles({
            display: "block", "line-height": "16px", "margin-left": "18px", "white-space": "normal"
        });
        f.append(g);
        f.append(e);
        return f
        ...
        var c = new v(b), b = "wscLang" + a.dialog.getParentEditor().name, b = document.getElementById(b), d = a.iframeNumber + "_" + a.dialog._.currentTabId;
        ...
        iframeOnload: function () {
            ...
            for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)a.grammerSuggest.getElement().append(y(b[f], b[f], d)), d = !1;
            l();
            a.div_overlay.setDisable()
    ...
    CKEDITOR.dialog.add("checkspell", function (b) {
        ...
        return {
            title: b.config.wsc_dialogTitle || b.lang.wsc.title, minWidth: 560, minHeight: 444, buttons: [CKEDITOR.dialog.cancelButton], onLoad: function () {
                a.dialog = this;
                a.dialog.hidePage("Thesaurus");
                p();
                r()
                    ...
                    type: "hbox", id: "bottomGroup", style: "width:560px; margin: 0 auto;", widths: ["50%", "50%"], children: [{
                        ...
                        type: "hbox", id: "rightCol", align: "right", width: "50%", children: [{
                            ...
                            children: [{
                                ...
                                type: "button", id: "AddWord", label: a.LocalizationButton.AddWord.text, title: "Add word", style: "width: 100%;", onLoad: function () {
                                    this.getElement().setAttribute("title-cmd", this.id);
    ...
    CKEDITOR.dialog.on("resize", function (b) {
        ...
        "checkspell" == c._.name && (a.bnr ? d && d.setSize("height", b.height - 310) : d && d.setSize("height", b.height - 220))
    });
