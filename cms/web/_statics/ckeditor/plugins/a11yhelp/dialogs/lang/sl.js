...
CKEDITOR.plugins.setLang("a11yhelp", "sl", {
    title: "Navodila Dostopnosti", contents: "Vsebina Pomoči. Če želite zapreti to pogovorno okno pritisnite ESC.", legend: [{
        name: "Splošno",
        items: [{
        ...
        }, {name: "Ležeči ukaz", legend: "Pritisnite ${italic}"}, {name: "Poudarni ukaz", legend: "Pritisnite ${underline}"}, {
            name: "Ukaz povezave",
