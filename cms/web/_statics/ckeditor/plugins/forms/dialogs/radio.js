...
CKEDITOR.dialog.add("radio", function (d) {
    return {
        title: d.lang.forms.checkboxAndRadio.radioTitle, minWidth: 350, minHeight: 140, onShow: function () {
            ...
            elements: [{
                ...
                id: "value", type: "text", label: d.lang.forms.checkboxAndRadio.value, "default": "", accessKey: "V", setup: function (a) {
                ...
                id: "checked", type: "checkbox", label: d.lang.forms.checkboxAndRadio.selected, "default": "", accessKey: "S", value: "checked", setup: function (a) {
                    ...
                    var b = a.element;
                    if (!CKEDITOR.env.ie && !CKEDITOR.env.opera)this.getValue() ? b.setAttribute("checked", "checked") : b.removeAttribute("checked"); else {
                        var c = b.getAttribute("checked"), e = !!this.getValue();
                        c != e && (c = CKEDITOR.dom.element.createFromHtml('<input type="radio"' + (e ? ' checked="checked"' : "") + "></input>", d.document), b.copyAttributes(c, {
                            type: 1,
                            checked: 1
