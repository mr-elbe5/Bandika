...
public enum PagePartAction implements IAction {
    /**
     * no action
     */
    defaultAction {
    ...
    /**
     * opens dialog for setting the currently visible content index
     */
    openSetVisibleContentIdx {
        @Override
        public boolean execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
            int pageId = RequestReader.getInt(request, "pageId");
            if (!hasContentRight(request, pageId, Right.EDIT))
            ...
            String sectionName = RequestReader.getString(request, "sectionName");
            data.setEditPagePart(sectionName, partId);
            return showSetVisibleContentIdx(request, response);
        }
    },
    /**
     * saves the currently visible content index
     */
    saveVisibleContentIdx {
        @Override
        public boolean execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
            int pageId = RequestReader.getInt(request, "pageId");
            if (!hasContentRight(request, pageId, Right.EDIT))
            ...
            PagePartData part = data.getEditPagePart();
            checkObject(part, partId);
            part.setCurrentContentIdx(RequestReader.getInt(request, "contentIdx"));
            data.setEditPagePart(null);
            return closeLayerToUrl(request, response, "/page.srv?act=reopenEditPageContent&pageId=" + data.getId());
        }
    },
    ...
    protected boolean showSetVisibleContentIdx(HttpServletRequest request, HttpServletResponse response) {
        return sendForwardResponse(request, response, "/WEB-INF/_jsp/page/setVisibleContentIdx.ajax.jsp");
    }
    ...
    protected boolean showSharedPartDetails(HttpServletRequest request, HttpServletResponse response) {return sendForwardResponse(request, response, "/WEB-INF/_jsp/page/sharedPagePartDetails.ajax.jsp");}
