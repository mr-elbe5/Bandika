...
import de.elbe5.field.FieldAction;
...
public class TreeHelper {
    ...
    public static void addAdminSiteNode(SiteData data, int currentId, List<Integer> activeIds, HttpServletRequest request, Locale locale, JspWriter writer) throws IOException {
        ...
        if (SessionReader.hasContentRight(request,data.getId(),Right.EDIT)) {
            ...
            writer.write("</div>");
            writer.write("<div class=\"icn isite\" onclick=\"return openLayerDialog('" + StringUtil.getHtml("_createSite", locale) + "', '");
            ...
            writer.write("</div>");
            writer.write("<div class=\"icn ipage\" onclick=\"return openLayerDialog('" + StringUtil.getHtml("_createPage", locale) + "', '");
            ...
            writer.write("</div>");
            writer.write("<div class=\"icn ifile\" onclick=\"return openLayerDialog('" + StringUtil.getHtml("_createFile", locale) + "', '");
        ...
        if (data.getSites().size() + data.getPages().size() + data.getFiles().size() > 0) {
            ...
            writer.write(">");
            writer.write("<div class=\"contextSource icn ifile\" >");
    ...
    public static void addAdminFileNode(FileData data, int currentId, HttpServletRequest request, Locale locale, JspWriter writer) throws IOException {
        ...
        if (SessionReader.hasContentRight(request,data.getId(),Right.EDIT)) {
            ...
            writer.write(StringUtil.getHtml("_settings", locale));
            writer.write("</div>");
            writer.write("<div class=\"icn idownload\" onclick=\"return linkToTree('/file.srv?act=download&fileId=" + data.getId() + "');\">");
