...
public class ForumControl extends TemplateControl {
    ...
    public void writeHtml(PageOutputContext outputContext, PageOutputData outputData) throws IOException {
        ...
        if (SessionReader.isEditMode(outputContext.getRequest()) && page.isPageEditMode()) {
            writer.write("<div class=\"forum\">FORUM</div>");
        }
        else{
            writer.write("<div class=\"forum\">");
            try {
                ...
                outputContext.includeJsp("/WEB-INF/_jsp/forum/forum.jsp");
            } catch (ServletException e) {
                Log.error("could not include forum jsp", e);
            }
            writer.write("</div>");
        }
    }
