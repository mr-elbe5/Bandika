...
public class ErrorMessage extends Message {
    ...
    public static void setMessage(HttpServletRequest request, String text) {
        request.setAttribute(Statics.KEY_MESSAGE, new ErrorMessage(text));
    }

    public static void setMessageByKey(HttpServletRequest request, Strings stringEnum) {
        setMessageByKey(request, stringEnum.toString());
    }

    public static void setMessageByKey(HttpServletRequest request, String key) {
        request.setAttribute(Statics.KEY_MESSAGE, new ErrorMessage(StringCache.getString(key, RequestReader.getSessionLocale(request))));
    }
