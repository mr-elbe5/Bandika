...
public class SessionReader {
    ...
    public static UserData getSessionLoginData(HttpServletRequest request) {
        return (UserData) getSessionObject(request, Statics.KEY_LOGIN);
    }

    public static Locale getSessionLocale(HttpServletRequest request) {
        Locale locale = (Locale) getSessionObject(request, Statics.KEY_LOCALE);
        if (locale == null) {
    ...
    public static String getSessionHost(HttpServletRequest request) {
        return (String) getSessionObject(request, Statics.KEY_HOST);
    }

    public static String getLoginName(HttpServletRequest request) {
        UserData loginData = getSessionLoginData(request);
    ...
    public static boolean hasAnySystemRight(HttpServletRequest request) {
        UserData data = getSessionLoginData(request);
    ...
    public static boolean isEditMode(HttpServletRequest request){
        return request!=null && getSessionObject(request, Statics.KEY_EDITMODE) != null;
    }
}
