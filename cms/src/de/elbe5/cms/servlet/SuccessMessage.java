...
public class SuccessMessage extends Message {
    ...
    public static void setMessage(HttpServletRequest request, String text) {
        request.setAttribute(Statics.KEY_MESSAGE, new SuccessMessage(text));
    }
    ...
    public static void setMessageByKey(HttpServletRequest request, String key) {
        request.setAttribute(Statics.KEY_MESSAGE, new SuccessMessage(StringCache.getString(key, RequestReader.getSessionLocale(request))));
    }
