...
public abstract class ResourceSearchData extends SearchData {
    ...
    public void setDoc() {
        ...
        doc.add(new Field("keywords", keywords, TextField.TYPE_STORED));
        doc.add(new Field("authorName", authorName, TextField.TYPE_STORED));
