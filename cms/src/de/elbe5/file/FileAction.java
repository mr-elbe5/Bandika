...
public enum FileAction implements ITreeAction {
    ...
    /**
     * cuts file from tree for pasteing somewhere else
     */
    cutFile {
        @Override
        public boolean execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    protected boolean showFileDetails(HttpServletRequest request, HttpServletResponse response) {return sendForwardResponse(request, response, "/WEB-INF/_jsp/file/fileDetails.ajax.jsp");}
