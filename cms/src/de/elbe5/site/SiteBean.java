...
public class SiteBean extends TreeBean {
    ...
    public List<SiteData> getAllSites() {
        ...
        try {
            con = getConnection();
            pst = con.prepareStatement("SELECT t1.id,t1.creation_date,t1.change_date,t1.parent_id,t1.ranking,t1.name," + "t1.display_name,t1.description,t1.author_name,t1.visible,t1.anonymous,t1.inherits_rights," + "t2.template " + "FROM t_treenode t1, t_site t2 " + "WHERE t1.id=t2.id " + "ORDER BY t1.parent_id NULLS FIRST, t1.ranking");
