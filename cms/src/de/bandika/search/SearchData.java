...
public class SearchData {
    ...
    protected DataType type = DataType.undefined;
    protected int id = 0;
    ...
    public static String getKey(int id, SearchData.DataType dataType) {
        return Integer.toString(id) + "#" + dataType.name();
    }

    public static Term getTerm(int id, SearchData.DataType dataType) {
        return new Term("key", getKey(id, dataType));
    }

    public String getKey() {
        return getKey(getId(), getType());
    }
    ...
    public void setDoc() {
        ...
        doc.add(new Field("type", getType().name(), TextField.TYPE_STORED));
