...
public enum SearchAction implements IAction {
    /**
     * no action
     */
    defaultAction {
    ...
    protected boolean showSearch(HttpServletRequest request, HttpServletResponse response) {
        return sendJspResponse(request, response, "/WEB-INF/_jsp/search/search.jsp", TemplateStatics.PAGE_MASTER);
    }

    protected boolean showSearchDetails(HttpServletRequest request, HttpServletResponse response) {return sendForwardResponse(request, response, "/WEB-INF/_jsp/search/searchDetails.ajax.jsp");}
