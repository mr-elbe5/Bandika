...
-- root page
INSERT INTO t_page (id, type, parent_id, ranking, name, description, author_name, in_topnav, in_footer,
...
$$
BEGIN
    INSERT INTO t_page (id, parent_id, ranking, type, name, description, author_name, master)
    VALUES (_pageId, _parentId, _ranking, 'TemplatePageData', _name, '', 'System', _masterTemplate);
