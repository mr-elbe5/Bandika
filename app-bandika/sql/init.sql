...
-- inserts
-- locales
INSERT INTO t_locale (locale, home_id)
VALUES ('en', 0);
--
INSERT INTO t_locale (locale, home_id)
VALUES ('de', 0);
...
VALUES (1, 'Sys', 'Admin', 'root@localhost', 'root', 'A0y3+ZmqpMhWA21VFQMkyY6v74Y=', '', TRUE);
...
-- root page
INSERT INTO t_page (id, parent_id, ranking, name, description, author_name, in_topnav, in_footer,
...
-- timer
INSERT INTO t_timer_task (name, display_name, execution_interval, active) VALUES('heartbeat','Heartbeat Task','CONTINOUS', FALSE);
INSERT INTO t_timer_task (name, display_name, execution_interval, active) VALUES('searchindex','Search Index Task','CONTINOUS', FALSE);
--
  --
  -- conveniance methods
  --
CREATE OR REPLACE FUNCTION addPage(_parentId INTEGER, _pageId INTEGER, _ranking INTEGER, _name VARCHAR(100),
                                   _masterTemplate VARCHAR(255),
                                   _pageTemplate VARCHAR(255)) RETURNS INTEGER AS
$$
BEGIN
  INSERT INTO t_page (id, parent_id, ranking, name, description, author_name, master, template)
  VALUES (_pageId, _parentId, _ranking, _name, '', 'System', _masterTemplate, _pageTemplate);
  RETURN _pageId;
END;
$$ LANGUAGE plpgsql;
--
