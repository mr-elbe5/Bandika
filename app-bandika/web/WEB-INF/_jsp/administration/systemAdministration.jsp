        ...
        <ul class="tree">
            <li class="open">
                ...
                <ul>
                    ...
                    %>
                    <li><a href=""
                           onclick="return openModalDialog('/admin/openExecuteDatabaseScript');"><%=Strings._executeDatabaseScript.html(locale)%>
                    </a></li>
                    <li><a href=""
                           onclick="if (confirmExecute()) return openModalDialog('/admin/restart');"><%=Strings._restart.html(locale)%>
                    </a>
                    <li class="open">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="icons"><a class="icon fa fa-trash-o" href="/admin/clearFileCache" title="<%=Strings._clear.html(locale)%>"></a></div>
                            </li>
                            <li>
                                <span><%=Strings._fileCache.html(locale)%></span>
                                <div class="icons"><a class="icon fa fa-refresh" href="/admin/reloadCache" title="<%=Strings._reload.html(locale)%>"></a></div>
                            </li>
                        </ul>
                    </li>
