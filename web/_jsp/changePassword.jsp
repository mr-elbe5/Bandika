...
<bnd:setMaster master="/_jsp/master.jsp">
    ...
    <div class="userTopHeader"><%=UserStrings.changepassword%></div>
		<bnd:userTable>
    <bnd:userTextInput label="<%=UserStrings.login%>" name="login" mandatory="true" text="" maxlength="30" />
    <bnd:userPasswordInput label="<%=UserStrings.oldpassword%>" name="oldPassword" mandatory="true" text="" maxlength="16" />
    <bnd:userPasswordInput label="<%=UserStrings.newpassword%>" name="newPassword1" mandatory="true" text="" maxlength="16" />
    <bnd:userPasswordInput label="<%=UserStrings.retypepassword%>" name="newPassword2" mandatory="true" text="" maxlength="16" />
    </bnd:userTable>
    <div class="userTableButtonArea">
      <button	onclick="return linkTo('/index.jsp');"><%=UserStrings.cancel%></button>
			<button	onclick="document.form.submit();"><%=UserStrings.change%></button>
		</div>
	</form>
