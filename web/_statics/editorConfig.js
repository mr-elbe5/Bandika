...
CKEDITOR.editorConfig = function( config ) {
  ...
  config.filebrowserBrowseUrl = '/_jsp/documentSelect.jsp?ctrl=doc&method=openDocumentSelector&forCk=1';
  config.filebrowserWindowWidth = '650';
  config.filebrowserWindowHeight = '300';

  config.filebrowserImageBrowseUrl = '/_jsp/imageSelect.jsp?ctrl=img&method=openImageSelector&forCk=1';
