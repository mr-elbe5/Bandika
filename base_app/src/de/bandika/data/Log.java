...
public class Log {
    ...
    private static Logger julog=Logger.getLogger("bandika");
    ...
    private static void log(int level,String message, Throwable t){
        ...
        Level lev;
        switch (level){
            case LOG:lev=Level.INFO;break;
            case INFO:lev=Level.INFO;break;
            case WARN:lev=Level.WARNING;break;
            case ERROR:lev=Level.SEVERE;break;
            default: lev=Level.OFF;break;
        }
