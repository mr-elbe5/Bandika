...
public class TemplatePartBean extends PagePartBean {

    private static TemplatePartBean instance = null;

    public static TemplatePartBean getInstance() {
        if (instance == null) {
            instance = new TemplatePartBean();
        }
        return instance;
    }
    ...
    public void readPartExtras(Connection con, PagePartData partData) throws SQLException {
        if (!(partData instanceof TemplatePartData))
            return;
        TemplatePartData data = (TemplatePartData) partData;
    ...
    public void readAllPartFields(Connection con, TemplatePartData data) throws SQLException {
        PreparedStatement pst = null;
        PartField field;
    ...
    public void writeAllPartFields(Connection con, TemplatePartData part) throws SQLException {
