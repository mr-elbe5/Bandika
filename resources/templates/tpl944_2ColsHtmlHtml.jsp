...
<%
  ...
  String[][] fieldDescriptions = {{"html1", "html"}, {"html2", "html"}};
  pdata.ensureFields(fieldDescriptions);
%>
<tr>
  <td colspan="3" class="c_2column"><%=pdata.getFieldHtml("html1", sdata.getLocale(), editMode)%>
  </td>
  <td>&nbsp;</td>
  <td colspan="3" class="c_2column"><%=pdata.getFieldHtml("html2", sdata.getLocale(), editMode)%>
  </td>
</tr>
