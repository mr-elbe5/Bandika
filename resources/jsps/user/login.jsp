...
<form action="srv25" method="post" name="loginForm" accept-charset="<%=Statics.ISOCODE%>">
  ...
  <div class="userForm" style="padding:10px;">
    ...
    <div class="userFormLine">
      <div class="userFormLabel"><%=Strings.getHtml("password", sdata.getLocale())%>*</div>
      <div><input class="userFormInput" type="password" name="password" maxlength="16" value=""/><input
          type="image" src="<%=Statics.IMG_PATH%>trans.gif"/></div>
    </div>
  </div>
  <ul class="userFormButtonList">
    <li class="userFormButton"><a href="#"
                                  onClick="document.loginForm.submit();"><%=Strings.getHtml("login", sdata.getLocale())%>
    </a></li>
  </ul>
</form>
