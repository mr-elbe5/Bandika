...
<%
  ...
  try {
    UserBean ts = (UserBean) Statics.getBean(Statics.KEY_USER);
...
<form action="srv25" method="post" name="form" accept-charset="<%=Statics.ISOCODE%>">
  ...
  <div class="admin">
    <table class="adminTable">
      <tr class="adminHeader">
        ...
        <td class="adminCharCol"><%=Strings.getHtml("editor", sdata.getLocale())%>
        </td>
        <td class="adminCharCol"><%=Strings.getHtml("administrator", sdata.getLocale())%>
        </td>
      </tr>
      ...
      <tr class="<%=otherLine? "adminWhiteLine" : "adminGreyLine"%>">
        <td><input type="radio" name="uid" value="<%=user.getId()%>"/></td>
  ...
  <ul class="adminButtonList">
    ...
    <li class="adminButton"><a
        href="srv25?ctrl=<%=Statics.KEY_USER%>&method=openCreateUser"><%=Strings.getHtml("new", sdata.getLocale())%>
    </a></li>
    <li class="adminButton"><a href="#"
                               onClick="submitMethod('openEditUser');"><%=Strings.getHtml("change", sdata.getLocale())%>
    </a></li>
    <li class="adminButton"><a href="#"
                               onClick="submitMethod('openDeleteUser');"><%=Strings.getHtml("delete", sdata.getLocale())%>
    </a></li>
  </ul>
</form>
