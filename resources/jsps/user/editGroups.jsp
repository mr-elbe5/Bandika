...
<form action="srv25" method="post" name="form" accept-charset="<%=Statics.ISOCODE%>">
  ...
  <div class="admin">
    <table class="adminTable">
      ...
      <tr class="<%=otherLine? "adminWhiteLine" : "adminGreyLine"%>">
        <td><input type="radio" name="gid" value="<%=group.getId()%>"/></td>
  ...
  <ul class="adminButtonList">
    ...
    <li class="adminButton"><a
        href="srv25?ctrl=<%=Statics.KEY_USER%>&method=openCreateGroup"><%=Strings.getHtml("new", sdata.getLocale())%>
    </a></li>
    <li class="adminButton"><a href="#"
                               onClick="submitMethod('openEditGroup');"><%=Strings.getHtml("change", sdata.getLocale())%>
    </a></li>
    <li class="adminButton"><a href="#"
                               onClick="submitMethod('openDeleteGroup');"><%=Strings.getHtml("delete", sdata.getLocale())%>
    </a></li>
  </ul>
</form>
