...
<div class="admin">
  <div class="adminLine">
    <%=Strings.getHtml("reallyDeleteDocument", sdata.getLocale())%>
  </div>
</div>
<div class="hline">&nbsp;</div>
<ul class="adminButtonList">
  <li class="adminButton"><a
      href="srv25?ctrl=<%=Statics.KEY_DOCUMENT%>&method=deleteDocument&did=<%=id%>"><%=Strings.getHtml("delete", sdata.getLocale())%>
  </a></li>
  <li class="adminButton"><a
