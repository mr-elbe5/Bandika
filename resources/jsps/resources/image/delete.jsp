...
<div class="admin">
  <div class="adminLine">
    <img src="srv25?ctrl=<%=Statics.KEY_IMAGE%>&method=showThumbnail&iid=<%=id%>" alt="">
  </div>
  <div class="adminLine">
    <%=Strings.getHtml("reallyDeleteImage", sdata.getLocale())%>
  </div>
  <div>&nbsp;</div>
</div>
<div class="hline">&nbsp;</div>
<ul class="adminButtonList">
  <li class="adminButton"><a
      href="srv25?ctrl=<%=Statics.KEY_IMAGE%>&method=deleteImage&iid=<%=id%>"><%=Strings.getHtml("delete", sdata.getLocale())%>
  </a></li>
  <li class="adminButton"><a
