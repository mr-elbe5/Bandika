...
<div class="admin">
  <div class="adminLine">
    <img src="srv25?ctrl=<%=Statics.KEY_IMAGE%>&method=showThumbnail&iid=<%=img.getId()%>" alt="">
  </div>
  <div class="adminLine">
    <%=Strings.getHtml("imageUploaded", sdata.getLocale())%>
  </div>
  <div>&nbsp;</div>
</div>
<div class="hline">&nbsp;</div>
<ul class="adminButtonList">
  <li class="adminButton"><a href="#"
                             onclick="opener.ImageUploadCallback('<%=img.getId()%>');window.close();"><%=Strings.getHtml("close", sdata.getLocale())%>
  </a></li>
</ul>
