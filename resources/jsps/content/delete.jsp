...
<div class="admin">
  <div class="adminLine">
    <%=Strings.getHtml("reallyDeleteContent", sdata.getLocale())%>
  </div>
</div>
<div class="hline">&nbsp;</div>
<ul class="adminButtonList">
  <li class="adminButton"><a
      href="srv25?ctrl=<%=Statics.KEY_CONTENT%>&method=delete&id=<%=id%>"><%=Strings.getHtml("delete", sdata.getLocale())%>
  </a></li>
  <li class="adminButton"><a
      href="srv25?ctrl=<%=Statics.KEY_CONTENT%>&method=show&id=<%=id%>"><%=Strings.getHtml("cancel", sdata.getLocale())%>
  </a></li>
</ul>
