...
<script type="text/javascript">
  ...
  function callFieldCallback(fileId) {
    <% if (selectData.getAssetType().equals(PageAssetSelectData.ASSET_TYPE_LINK)){%>
    opener.setLink('/_file?method=show&fid=' + fileId);
    <%} else{%>
    opener.setImage(fileId);
    <%}%>
    window.close();
  }
</script>
<form class="form-horizontal" action="/_file" method="post" name="form" accept-charset="UTF-8">
  ...
  <div class="well">
    <bandika:dataTable id="fileTable" formName="form" headerKeys="name,select,preview,dimension,exclusive" sort="true" paging="true" displayLength="5">
