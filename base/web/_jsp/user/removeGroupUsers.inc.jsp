...
<div class="layerContent">
  <div class="well">
    <table class="table">
      ...
      <tr>
        ...
        <td><%=FormatHelper.toHtml(udata.getName())%>
        </td>
      </tr>
      <%}%>
      </tbody>
  ...
  <div class="btn-toolbar">
    <button class="btn btn-primary" onclick="document.form.method.value='removeGroupUsers';document.form.submit();"><%=StringCache.getHtml("remove")%>
    </button>
  </div>
</div>
