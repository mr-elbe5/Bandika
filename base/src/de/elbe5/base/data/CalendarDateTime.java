...
public class CalendarDateTime {
    ...
    protected Scope scope= Scope.MONTH;
    ...
    public String toString(){
        ...
        sb.append("\ntoday:").append(today);
        sb.append("\nscope:").append(scope);
        sb.append("\ncurrentMonth:").append(getCurrentMonth());
        sb.append("\nfirstVisibleDay:").append(firstVisibleDay);
        sb.append("\nfirstDayInScope:").append(firstDayInScope);
        sb.append("\nlastDayInScope:").append(lastDayInScope);
        sb.append("\nlastVisibleDay:").append(lastVisibleDay);
        sb.append("\ndays:").append(days);
        sb.append("\nvisibleDays:").append(visibleDays);
        return sb.toString();
    }
