...
public class TimerTaskData implements Cloneable {
  ...
  public final static String DATAKEY = "data|timertask";
    ...
    try {
      ...
      if (className != null && !className.equals("")) {
        try {
          ...
          Logger.warn(getClass(), "could not load class " + className + "for task " + getName());
        }
      }
  ...
  public boolean execute(Date now, boolean isMaster) {
    if (task != null && (!isMasterOnly() || isMaster)) {
