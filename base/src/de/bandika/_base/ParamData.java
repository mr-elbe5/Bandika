...
public class ParamData {
  ...
  public float getParamCurrency(String key, Locale locale)
  ...
  public Date getParamDate(String key, String datePattern) {
    return getParamDate(key, new SimpleDateFormat(datePattern));
  }
  ...
  public ArrayList<String> getParamStringList(String key) {
      ...
      if (values != null) {
        for (String value : values) {
          try {
            ...
            Logger.error(getClass(), "wrong number format: "
              + value);
          }
        }
      }
