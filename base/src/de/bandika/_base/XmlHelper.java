...
public class XmlHelper {
  ...
  public static Element createChild(Document doc, Element parentNode,
                                    String name) {
  ...
  public static CDATASection createCDATA(Document doc, Element parentNode,
                                         String content) {
  ...
  public static Attr createAttribute(Document doc, Element parentNode,
  ...
  public static Attr createIntAttribute(Document doc, Element parentNode,
                                        String key, int value) {
    return createAttribute(doc, parentNode, key, Integer.toString(value));
  }

  public static Attr createLongAttribute(Document doc, Element parentNode,
                                         String key, long value) {
    return createAttribute(doc, parentNode, key, Long.toString(value));
  }

  public static Attr createBooleanAttribute(Document doc, Element parentNode,
