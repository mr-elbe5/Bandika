...
public class ClusterMessageProcessor extends Controller implements IPortObjectProcessor {
  ...
  HashMap<String, IChangeListener> listeners = null;

  public void initialize() {
    listeners = new HashMap<String, IChangeListener>();
  }
    ...
    switch (msg.getMessageType()) {
      ...
      case ClusterMessage.MSGTYPE_LISTENER: {
        ...
        if (listeners.containsKey(messageKey)) {
          Logger.info(null, String.format("dispatching cluster message to listener: %s", listeners.get(messageKey)));
