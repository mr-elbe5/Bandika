...
import de.bandika.cloud.servlet.ICloudAction;
...
public enum InstallerAction implements ICloudAction {
    /**
    ...
    setSystemPassword {
                ...
                public boolean execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
                    ...
                    if (!LoginBean.getInstance().changePassword(UserLoginData.ID_SYSTEM, systemPassword)) {
