...
public class Logger {
	...
	protected void printLog(Class cls, String message, Throwable t, RequestData rdata) {
		if (!isValidThrowable(cls, t))
			return;
		StringBuffer buffer = new StringBuffer();
		if (rdata != null) {
	...
	public static void log(Class cls, String message, Throwable t, RequestData rdata) {
