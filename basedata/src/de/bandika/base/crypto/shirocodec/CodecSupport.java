 ...
 * under the License.
 */
package de.bandika.base.crypto.shirocodec;
...
public abstract class CodecSupport {
     ...
     * <p/>
     * <code>toBytes( new String(chars), {@link CodecSupport#PREFERRED_ENCODING PREFERRED_ENCODING}
     * );</code>
     *
    ...
    /**
     * Converts the specified byte array to a String using the specified character
     * encoding. This implementation does the same thing as
     * <code>new {@link String#String(byte[], String) String(byte[], encoding)}</code>,
     * but will wrap any {@link UnsupportedEncodingException} with a nicer runtime
     * {@link CodecException}, allowing you to decide whether or not you want to
     * catch the exception or let it propagate.
     *
    ...
    /**
     * Converts the specified byte array to a character array using the specified
     * character encoding.
     * <p/>
     * Effectively calls
     ...
     * <p/>
     * The default implementation returns {@code true} IFF the specified object is
     ...
     * </ul>
     *
     * @param o the object to test to see if it can be easily converted to a byte
     *          array
     ...
     * {@code byte[]}, {@code char[]}, {@link ByteSource}, {@link String}, {@link File},
     * or {@link InputStream}, it will be converted automatically and returned.}
     * <p/>
     ...
     * <p/>
     * If the argument is a {@code byte[]} or {@code char[]} it will be converted
     * to a String using the {@link #PREFERRED_ENCODING}. If a String, it will be
     * returned as is.
     * <p/>
     ...
     * @throws IllegalArgumentException if the {@code InputStream} argument is
     *                                  {@code null}.
     * @throws CodecException           if there is any problem reading from the
     *                                  {@link InputStream}.
     * @since 1.0
     */
     ...
     * (listed in the {@link #toBytes(Object) toBytes(Object)} JavaDoc) are to be
     ...
     * <code>objectArgument.toString()</code>. Subclasses can override this method
     * for different mechanisms of converting an object to a String.
     *
     * @param o the Object to convert to a byte array.
