 ...
 */
package de.elbe5.base.catalina;
...
public class FilePath {
    ...
    public static void initializePath(File appDir, File appROOTDir) {
        if (appDir == null || appROOTDir == null) return;
        appPath = appDir.getAbsolutePath().replace('\\', '/');
        Log.log("application path is: " + FilePath.getAppPath());
        FilePath.appROOTPath = appROOTDir.getAbsolutePath().replace('\\', '/');
    }
