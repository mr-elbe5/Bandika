...
<%
    ...
    String url = "/ctrl/sectionpage/sendContact/" + contentData.getId();
...
<% if (!editing) {%>
            <form:form url="<%=url%>" name="contactform" >
                ...
                <div class="pull-right">
                    <button type="submit" class="btn btn-outline-primary"><%=$SH("_send",locale)%>
                    </button>
                </div>
            </form:form>
<%} else {%>
            ...
            <div class="pull-right">
                <button type="submit" class="btn btn-outline-primary" disabled><%=$SH("_send",locale)%>
                </button>
            </div>
<%}%>
