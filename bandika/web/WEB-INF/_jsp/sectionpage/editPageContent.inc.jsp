...
<%
    ...
    <form action="/ctrl/sectionpage/saveContentFrontend/<%=contentData.getId()%>" method="post" id="pageform" name="pageform" accept-charset="UTF-8">
        <div class="btn-group btn-group-sm pageEditButtons">
            ...
            <button class="btn btn-sm btn-secondary" onclick="return linkTo('/ctrl/sectionpage/cancelEditContentFrontend/<%=contentData.getId()%>');"><%=$SH("_cancel", locale)%></button>
        </div>
    ...
    <script type="text/javascript">
        ...
        function addPart(fromId, section, type, layout){
            ...
            $.ajax({
                url: '/ctrl/sectionpage/addPart/'+<%=contentData.getId()%>,
                type: 'POST',
                data: data,
                dataType: 'html'
