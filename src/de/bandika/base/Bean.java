...
public class Bean {
	...
	protected static HashMap<String, Bean> beans = new HashMap<String, Bean>();
	...
	public static void addBean(String key, Bean bean) {
		...
		if (cache != null)
			DataCache.caches.put(key, cache);
	}
	...
	protected Connection getConnection() throws SQLException {
		return BaseConfig.getConnection();
	}

	protected Connection startTransaction() {
		try {
			Connection con = BaseConfig.getConnection();
