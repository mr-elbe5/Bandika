...
public class HttpHelper {
	...
	public static RequestData startJsp(HttpServletRequest request,HttpServletResponse response) throws ServletException{
	  setNoCache(response);
		RequestData rdata=ensureRequestData(request);
		ensureSessionData(request);
		return rdata;
	}
	...
	public static RequestData ensureRequestData(HttpServletRequest request) throws ServletException {
		RequestData reqData = getRequestData(request);
		if (!BaseConfig.initialized()) {
			try {
				BaseConfig.initialize(request);
			}
			catch (Exception e) {
	...
	public static SessionData ensureSessionData(HttpServletRequest request) throws ServletException {
	...
	private static void prepareSinglepartRequestData(HttpServletRequest request, RequestData rdata) throws ServletException {
	...
	private static void prepareMultipartRequestData(HttpServletRequest request, RequestData rdata) throws IOException {
		rdata.setRequest(request);
