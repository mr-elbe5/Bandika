...
public class ImageTool {
   ...
   * Method createImage
   *
   * @param img of type ImageBaseData
  ...
  /**
   * Method createJpegThumbnail
   *
   * @param img       of type ImageBaseData
   * @param image     of type BufferedImage
   * @param maxWidth  of type int
   * @param maxHeight of type int
   * @return boolean
   * @throws IOException when data processing is not successful
   */
  ...
  /**
   * Method setContentType sets the contentType of this ImageTool object.
   *
   * @param img the contentType of this ImageTool object.
   */
