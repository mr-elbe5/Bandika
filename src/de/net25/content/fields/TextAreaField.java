...
public class TextAreaField extends BaseField {
  ...
  /**
   * Method getText returns the text of this TextAreaField object.
   *
   * @return the text (type String) of this TextAreaField object.
   */
  ...
  /**
   * Method setText sets the text of this TextAreaField object.
   *
   * @param text the text of this TextAreaField object.
   */
  ...
  public String getEditHtml(Locale locale) {
    StringBuffer buffer = new StringBuffer("<textarea name=\"");
    buffer.append(getIdentifier());
    buffer.append("\" rows=\"5\" >");
    buffer.append(Formatter.toHtmlInput(text));
