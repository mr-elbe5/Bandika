...
public class Mailer {
    ...
    public boolean isComplete() {
        return BaseData.isComplete(smtpHost)
                && BaseData.isComplete(from)
                && BaseData.isComplete(to)
                && BaseData.isComplete(subject)
                && BaseData.isComplete(content);
    }
