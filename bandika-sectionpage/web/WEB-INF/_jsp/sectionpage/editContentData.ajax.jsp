...
<%
    ...
    List<LayoutData> masterLayouts = LayoutCache.getLayouts(PageData.MASTER_TYPE);
    List<LayoutData> pageLayouts = LayoutCache.getLayouts(SectionPageData.PAGE_TYPE);
    String url = "/ctrl/sectionpage/saveContentData/" + contentData.getId();
%>
