...
public class TemplateController extends Controller {
    ...
    public IActionResult openTemplateAdministration(RequestData rdata) {
        ...
        return openAdminPage(rdata, "/WEB-INF/_jsp/template/templateAdministration.jsp", Strings.string("_templateAdministration",rdata.getSessionLocale()));
    }
    ...
    public IActionResult importTemplates(RequestData rdata) {
        ...
        if (!success) {
            rdata.setMessage(Strings.string("_importError",rdata.getSessionLocale()), Statics.MESSAGE_TYPE_ERROR);
            return showImportTemplates();
        }
        TemplateBean.getInstance().writeAllTemplateFiles();
        rdata.setMessage(Strings.string("_templatesImported",rdata.getSessionLocale()), Statics.MESSAGE_TYPE_SUCCESS);
    ...
    public IActionResult saveTemplate(RequestData rdata) {
        ...
        rdata.setMessage(Strings.string("_templateSaved",rdata.getSessionLocale()), Statics.MESSAGE_TYPE_SUCCESS);
        return new CloseDialogActionResult("/ctrl/template/openTemplateAdministration");
    }
    ...
    public IActionResult deleteTemplate(RequestData rdata) {
        ...
        rdata.setMessage(Strings.string("_templateDeleted",rdata.getSessionLocale()), Statics.MESSAGE_TYPE_SUCCESS);
