...
<li class="open">
    ...
    <ul>
        ...
        <li>
            ...
            <div class="icons">
                <a class="icon fa fa-pencil" href="" onclick="return openModalDialog('/timer/openEditTimerTask?timerName=<%=task.getName()%>');" title="<%=Strings.html("_edit",locale)%>"></a>
            </div>
        </li>
        <%
                }
