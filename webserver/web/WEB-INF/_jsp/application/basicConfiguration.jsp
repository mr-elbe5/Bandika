...
<form action = "/installer.srv" method = "post" name = "form" accept-charset = "UTF-8">
    <input type = "hidden" name = "act" value = "setBasicConfiguration"/>
    <fieldset>
        ...
        <table class = "form">
            ...
            <tr>
                ...
                <td><input type = "text" id = "dbClass" name = "dbClass" value = "<%=RequestHelper.getString(request,"dbClass")%>" maxlength = "255" placeholder = "ClassName"
                        required/>
                </td>
            </tr>
            <tr>
                ...
                <td><input type = "text" id = "dbUrl" name = "dbUrl" value = "<%=RequestHelper.getString(request,"dbUrl")%>" maxlength = "255" required/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type = "text" id = "dbUser" name = "dbUser" value = "<%=RequestHelper.getString(request,"dbUser")%>" maxlength = "60" required/>
                </td>
            </tr>
            <tr>
                <td>
