...
<%
    ...
    if (StringUtil.isNullOrEmtpy(title)) title = StringUtil.getString("_installation", SessionHelper.getSessionLocale(request));
    if (StringUtil.isNullOrEmtpy(title)) title = "Installation";
    String appTitle = Configuration.getInstance().getAppTitle();
    if (appTitle == null) appTitle = "Elbe 5";
%>
<html>
    <head>
        <meta charset = "utf-8"/>
        ...
        <div id = "viewport">
            <section class = "headerSection">
                <div class = "sectionInner flexbox">
                    <div class = "headerleft flexItemTwo">
                        <a class = "logo"><img src = "/_statics/img/logo.png" alt = "<%=appTitle%>"/></a>
                        <h1><%=appTitle%>
                        </h1>
                    </div>
                </div>
            ...
            <section class = "mainSection flexBox">
                ...
                <aside class = "asideSection flexItemOne">
                    <div class = "sectionInner">
                        <jsp:include page = "/WEB-INF/_jsp/application/basicStatus.jsp"/>
                    </div>
                </aside>
            </section>
