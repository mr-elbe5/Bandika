...
<section class="contentTop">
    <h1><%=Strings.html("_search",locale)%>
    </h1>
    <form action="/ctrl/search/search" method="post" id="searchboxform" name="searchboxform" accept-charset="UTF-8">
        <div class="input-group">
            ...
            <button class="btn btn-outline-primary my-2 my-sm-0" type="submit"><%=Strings.html("_search",locale)%>
            </button>
        </div>
    </form>
</section>
<section class="searchSection">
    <div class="searchResults">
        ...
        <h2><%=Strings.html("_searchResults",locale)%>
        </h2>
        ...
        <div class="searchResult">
            <div class="searchTitle">
                <a href="<%=data.getUrl()%>" title="<%=Strings.html("_show",locale)%>"><%=data.getNameContext()%>
                </a>
            </div>
        ...
        <span><%=Strings.html("_noResults",locale)%></span>
        <%}%>
    </div>
</section>
