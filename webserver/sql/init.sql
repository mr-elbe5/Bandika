...
--
insert into t_template (change_date,display_name,description,code,name,type) values(now(),'Default Master','','<!DOCTYPE html>
        <html lang="en"><head><title></title></head><body></body></html>','defaultMaster','MASTER');
-- file root folder
