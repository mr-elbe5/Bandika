...
<bandika:layout id="<%=data.getId()%>">
  <div class="row">
    <div class="span3 leftspan3"><bandika:area name="leftspan3" matchTypes="contentnavi"/></div>
    <div class="span6 mainspan6"><bandika:area name="mainspan6" matchTypes="content"/></div>
    <div class="span3 rightspan3"><bandika:area name="rightspan3" matchTypes="related"/></div>
  </div>
</bandika:layout>
