...
public class TeamChatClient extends BaseData implements HttpSessionBindingListener {
  ...
  public boolean isComplete(RequestData rdata) {
    ...
    boolean valid = DataHelper.isComplete(chatId) && DataHelper.isComplete(partId) && DataHelper.isComplete(pageId);
    if (!valid) {
