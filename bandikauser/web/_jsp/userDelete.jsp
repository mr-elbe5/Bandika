...
%>
  ...
  <bnd:adminTable>
    <tr class="adminHeader">
      <td class="adminMostCol"><%=Strings.getHtml("reallydeleteuser")%></td>
    </tr>
  ...
  <div class="adminTableButtonArea">
    ...
    <button	onclick="return linkTo('/_user?method=deleteUser&uid=<%=DataConverter.getIntString(ids)%>');"><%=Strings.getHtml("delete")%></button>
  </div>
